...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  createClass(ExtensionBlocks, [{
    ...
    value: function setDevicePower(args) {
      // const url = new URL('http://192.168.12.7');
      // url.pathname = 'api/5SxbisbyGZ9ve5dXxEs-afXPRbDiuvHDmbOacGdp/lights/1/state';
      var body = {
        host: 'http://192.168.12.7',
        username: '5SxbisbyGZ9ve5dXxEs-afXPRbDiuvHDmbOacGdp',
        data: {
          on: true,
          sat: 227,
          bri: 127,
